...
const Login = () => {
    ...
    const handleSubmitlogin = useCallback((e) => {
        ...
        if (!formDatalogin.email || !formDatalogin.password) {
            ...
            axios.post('http://localhost:8000/user/sign-in', formDatalogin)
                .then((res) => {
            ...
            <div className={`registercontainer ${slide ? "right-panel-active" : ""}`}>
                <div className="form-container sign-up-container">
                    <form className='form' onSubmit={handleSubmit} action="/">
                        ...
                        <div className='form-items'>
                            ...
                            <input type={showPassword ? 'text' : 'password'} name='password' placeholder="Enter New password" onChange={handleChange}/>
                        ...
                        <div className='form-items'>
                            ...
                            <input type={showPassword ? 'text' : 'password'} name='confirmpassword' placeholder="Enter New password" onChange={handleChange}/>
                            <div className="password-toggle" onClick={togglePasswordVisibility}>
                                {showPassword ? <FaEyeSlash /> : <FaEye />}
                            </div>
                        </div>
                ...
                <div className="form-container sign-in-container">
                    <form className='form' onSubmit={handleSubmitlogin}>
                        ...
                        <div className='form-items'>
                            <label htmlFor="" className='form-label'>Email address*</label>
                            <input type="email" placeholder="Enter your email" name='email' value={formDatalogin.email} onChange={handleChangelogin}/>
                        </div>
                        <div className='form-items'>
                            <label htmlFor="" className='form-label'>Password*</label>
                            <input type={showPassword ? 'text' : 'password'} placeholder="Enter your password" name='password' value={formDatalogin.password} onChange={handleChangelogin}/>
                            <div className="password-toggle" onClick={togglePasswordVisibility}>
                                {showPassword ? <FaEyeSlash /> : <FaEye />}
                            </div>
                        </div>
